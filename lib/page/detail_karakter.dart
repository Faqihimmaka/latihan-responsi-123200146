...
class DetailKarakter extends StatefulWidget {
  String name;
  DetailKarakter({Key? key, required this.name}) : super(key: key);

  @override
  State<DetailKarakter> createState() => _DetailKarakterPageState();
}

class _DetailKarakterPageState extends State<DetailKarakter> {
